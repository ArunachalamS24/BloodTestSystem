...
class LabRegister(models.Model):
    ...
    LabName=models.CharField(max_length=20,default='',verbose_name='LabName')
    DocName=models.CharField(max_length=20,default='',verbose_name='DocName')
    LabAddress=models.CharField(max_length=20,default='',verbose_name='LabAddress')
